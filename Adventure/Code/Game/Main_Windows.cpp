...
void StartUp()
{
	...
	myDoc.LoadFile("Data/GamePlay/GameConfig.xml");

	tinyxml2::XMLElement* configElement = myDoc.RootElement();
	
	std::string startLevel = ParseXmlAttribute(*configElement,"startLevel","None");
	std::string windowAspect = ParseXmlAttribute(*configElement,"windowAspect","None");
	std::string isFullScreen = ParseXmlAttribute(*configElement,"isFullscreen","None");

	g_gameConfigBlackboard.SetValue("startLevel",startLevel);
	g_gameConfigBlackboard.SetValue("windowAspect",windowAspect);
	g_gameConfigBlackboard.SetValue("isFullScreen",isFullScreen);
